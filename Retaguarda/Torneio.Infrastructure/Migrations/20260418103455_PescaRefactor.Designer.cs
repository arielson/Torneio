...
namespace Torneio.Infrastructure.Migrations
{
    ...
    [Migration("20260418103455_PescaRefactor")]
    partial class PescaRefactor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Torneio.Domain.Entities.AnoTorneio", b =>
                {
                    ...
                    b.HasIndex("TorneioId", "Titulo")
                        .IsUnique()
                        .HasDatabaseName("ix_anos_torneio_torneio_id_titulo");
            ...
            modelBuilder.Entity("Torneio.Domain.Entities.Premio", b =>
                {
                    ...
                    b.HasIndex("TorneioId")
                        .HasDatabaseName("ix_premios_torneio_id");

                    b.HasIndex("AnoTorneioId", "Posicao")
                        .IsUnique()
                        .HasDatabaseName("ix_premios_ano_torneio_id_posicao");
            ...
            modelBuilder.Entity("Torneio.Domain.Entities.Premio", b =>
                {
                    b.HasOne("Torneio.Domain.Entities.AnoTorneio", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_premios_anos_torneio_ano_torneio_id");
