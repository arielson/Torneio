...
{
    /// <inheritdoc />
    public partial class AdicionarLogAuditoria : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_logs_auditoria_categoria",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_logs_auditoria_torneio_id",
                table: "logs_auditoria",
                column: "torneio_id");
        }
        ...
        {
            migrationBuilder.DropTable(name: "logs_auditoria");
        }
    }
}
