...
namespace Torneio.Infrastructure.Migrations
{
    ...
    [Migration("20260421231440_AddFinanceiroOperacionalTorneio")]
    partial class AddFinanceiroOperacionalTorneio
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Torneio.Domain.Entities.Equipe", b =>
                {
                    ...
                    b.Property<string>("ResponsavelFinanceiro")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
            ...
            modelBuilder.Entity("Torneio.Domain.Entities.ParcelaTorneio", b =>
                {
                    ...
                    b.HasIndex("TorneioId", "MembroId", "NumeroParcela")
                        .IsUnique()
                        .HasDatabaseName("ix_parcelas_torneio_torneio_id_membro_id_numero_parcela");
